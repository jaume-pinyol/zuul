...
class ZuulNFRequest extends ZuulFilter {
    ...
    boolean shouldFilter() {
        return (NFRequestContext.currentContext.getRouteHost() == null
                && RequestContext.currentContext.sendZuulResponse()
                && NFRequestContext.currentContext.getRouteVIP() != null)
    }
...
//        if (Verb.DELETE.verb.equals(verb.verb)) {
//            requestEntity = null
//        }
